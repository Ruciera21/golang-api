...
ALTER TABLE "accounts" ADD CONSTRAINT "accounts_FK" FOREIGN KEY ("customer_id") REFERENCES "customers" ("customer_id");

ALTER TABLE "transactions" ADD CONSTRAINT "transactions_FK" FOREIGN KEY ("account_id") REFERENCES "accounts" ("account_id");
